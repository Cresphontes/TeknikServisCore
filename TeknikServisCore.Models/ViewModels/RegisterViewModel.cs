...
namespace TeknikServisCore.Models.ViewModels
{
    public class RegisterViewModel
    {
        ...
        [Required,Compare("Email"),DisplayName("Email Tekrar")]
        ...
        [Required,MinLength(6,ErrorMessage = "Şifreniz en az 6 karakter olmalıdır."),MaxLength(25,ErrorMessage = "Şifreniz en fazla 25 karakter olabilir."), DisplayName("Şifre")]
        public string Password { get; set; }
        [Required,Compare("Password"),DisplayName("Şifre Tekrar")]
